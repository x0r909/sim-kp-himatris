...
{
    private function canManageKeuangan(User $user): bool
    {
        return $user->canManageKeuangan();
    }

    private function canViewKeuangan(User $user): bool
    {
    ...
    {
        return $this->canViewKeuangan($user);
    }
    ...
    {
        return $this->canManageKeuangan($user);
    }
