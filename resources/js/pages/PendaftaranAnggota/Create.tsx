            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-4xl font-bold mb-2">Pendaftaran Anggota Baru</h1>
                        <p className="text-muted-foreground">Bergabunglah dengan kami dan kembangkan potensimu!</p>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Isi formulir di bawah ini dengan lengkap dan benar. Data kamu akan direview oleh admin.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="alasan_bergabung">Alasan Bergabung</Label>
                                        <Textarea
                                            id="alasan_bergabung"
                                            value={data.alasan_bergabung}
                                            onChange={(e) => setData('alasan_bergabung', e.target.value)}
                                            placeholder="Ceritakan alasan kamu ingin bergabung..."
                                            rows={4}
                                        />
                                        <InputError message={errors.alasan_bergabung} />
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        <p className="text-sm text-muted-foreground">Format: JPG, JPEG, PNG. Maksimal 2MB</p>
